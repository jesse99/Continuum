...
// /usr/local/bin/multimethod --result=int --name=ValueNumChildren --arg=object:owner --arg=object:item --namespace=Debugger
using System;
...
namespace Debugger
{
	...
	internal static class ValueNumChildren
	{
		...
		public static int Invoke(object owner, object item)
		{
			if (ms_candidates == null)
				DoAutoRegister();
			
			var __actual = new Entry(owner, item);
			...
			return ms_candidates[__index].Method(owner, item);
		}
		...
		// MissingMethodException or System.Reflection.AmbiguousMatchException.
		public static int NextMethod(object owner, object item)
		{
			var __actual = new Entry(owner, item);
		...
		private delegate int OverloadType(object owner, object item);
		
		private struct Entry : IEquatable<Entry>
		{
			public Entry(object owner, object item) : this()
			{
				Method = null;
