...
// /usr/local/bin/multimethod --result=string --name=ValueType --arg=object:owner --arg=object:item --namespace=Debugger
using System;
...
namespace Debugger
{
	...
	internal static class ValueType
	{
		...
		public static string Invoke(object owner, object item)
		{
		...
		// MissingMethodException or System.Reflection.AmbiguousMatchException.
		public static string NextMethod(object owner, object item)
		{
			var __actual = new Entry(owner, item);
		...
		private delegate string OverloadType(object owner, object item);
